...
namespace GlmSharp
{
    ...
    /// <summary>
    /// A matrix of type GlmHalf with 2 columns and 3 rows.
    /// </summary>
    [Serializable]
    [DataContract(Namespace = "mat")]
    [StructLayout(LayoutKind.Sequential)]
    public struct hmat2x3 : IReadOnlyList<GlmHalf>, IEquatable<hmat2x3>
    {
        ...
        /// </summary>
        public hmat2x3(GlmHalf m00, GlmHalf m01, GlmHalf m02, GlmHalf m10, GlmHalf m11, GlmHalf m12)
        {
            this.m00 = m00;
            this.m01 = m01;
            this.m02 = m02;
        ...
        /// </summary>
        public GlmHalf[,] Values => new[,] { { m00, m01, m02 }, { m10, m11, m12 } };

        /// <summary>
        /// Creates a 1D array with all values (internal order)
        /// </summary>
        public GlmHalf[] Values1D => new[] { m00, m01, m02, m10, m11, m12 };
        ...
        /// </summary>
        public static hmat2x3 Zero { get; } = new hmat2x3(GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero);

        /// <summary>
        /// Predefined all-ones matrix
        /// </summary>
        public static hmat2x3 Ones { get; } = new hmat2x3(GlmHalf.One, GlmHalf.One, GlmHalf.One, GlmHalf.One, GlmHalf.One, GlmHalf.One);

        /// <summary>
        /// Predefined identity matrix
        /// </summary>
        public static hmat2x3 Identity { get; } = new hmat2x3(GlmHalf.One, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.One, GlmHalf.Zero);

        /// <summary>
        /// Predefined all-MaxValue matrix
        /// </summary>
        public static hmat2x3 AllMaxValue { get; } = new hmat2x3(GlmHalf.MaxValue, GlmHalf.MaxValue, GlmHalf.MaxValue, GlmHalf.MaxValue, GlmHalf.MaxValue, GlmHalf.MaxValue);

        /// <summary>
        /// Predefined diagonal-MaxValue matrix
        /// </summary>
        public static hmat2x3 DiagonalMaxValue { get; } = new hmat2x3(GlmHalf.MaxValue, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.MaxValue, GlmHalf.Zero);

        /// <summary>
        /// Predefined all-MinValue matrix
        /// </summary>
        public static hmat2x3 AllMinValue { get; } = new hmat2x3(GlmHalf.MinValue, GlmHalf.MinValue, GlmHalf.MinValue, GlmHalf.MinValue, GlmHalf.MinValue, GlmHalf.MinValue);

        /// <summary>
        /// Predefined diagonal-MinValue matrix
        /// </summary>
        public static hmat2x3 DiagonalMinValue { get; } = new hmat2x3(GlmHalf.MinValue, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.MinValue, GlmHalf.Zero);

        /// <summary>
        /// Predefined all-Epsilon matrix
        /// </summary>
        public static hmat2x3 AllEpsilon { get; } = new hmat2x3(GlmHalf.Epsilon, GlmHalf.Epsilon, GlmHalf.Epsilon, GlmHalf.Epsilon, GlmHalf.Epsilon, GlmHalf.Epsilon);

        /// <summary>
        /// Predefined diagonal-Epsilon matrix
        /// </summary>
        public static hmat2x3 DiagonalEpsilon { get; } = new hmat2x3(GlmHalf.Epsilon, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Epsilon, GlmHalf.Zero);

        /// <summary>
        /// Predefined all-NaN matrix
        /// </summary>
        public static hmat2x3 AllNaN { get; } = new hmat2x3(GlmHalf.NaN, GlmHalf.NaN, GlmHalf.NaN, GlmHalf.NaN, GlmHalf.NaN, GlmHalf.NaN);

        /// <summary>
        /// Predefined diagonal-NaN matrix
        /// </summary>
        public static hmat2x3 DiagonalNaN { get; } = new hmat2x3(GlmHalf.NaN, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.NaN, GlmHalf.Zero);

        /// <summary>
        /// Predefined all-NegativeInfinity matrix
        /// </summary>
        public static hmat2x3 AllNegativeInfinity { get; } = new hmat2x3(GlmHalf.NegativeInfinity, GlmHalf.NegativeInfinity, GlmHalf.NegativeInfinity, GlmHalf.NegativeInfinity, GlmHalf.NegativeInfinity, GlmHalf.NegativeInfinity);

        /// <summary>
        /// Predefined diagonal-NegativeInfinity matrix
        /// </summary>
        public static hmat2x3 DiagonalNegativeInfinity { get; } = new hmat2x3(GlmHalf.NegativeInfinity, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.NegativeInfinity, GlmHalf.Zero);

        /// <summary>
        /// Predefined all-PositiveInfinity matrix
        /// </summary>
        public static hmat2x3 AllPositiveInfinity { get; } = new hmat2x3(GlmHalf.PositiveInfinity, GlmHalf.PositiveInfinity, GlmHalf.PositiveInfinity, GlmHalf.PositiveInfinity, GlmHalf.PositiveInfinity, GlmHalf.PositiveInfinity);

        /// <summary>
        /// Predefined diagonal-PositiveInfinity matrix
        /// </summary>
        public static hmat2x3 DiagonalPositiveInfinity { get; } = new hmat2x3(GlmHalf.PositiveInfinity, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.PositiveInfinity, GlmHalf.Zero);
        ...
        /// </summary>
        public GlmHalf MinElement => GlmHalf.Min(GlmHalf.Min(GlmHalf.Min(GlmHalf.Min(GlmHalf.Min(m00, m01), m02), m10), m11), m12);

        /// <summary>
        /// Returns the maximal component of this matrix.
        /// </summary>
        public GlmHalf MaxElement => GlmHalf.Max(GlmHalf.Max(GlmHalf.Max(GlmHalf.Max(GlmHalf.Max(m00, m01), m02), m10), m11), m12);
        ...
        /// </summary>
        public GlmHalf Sum => (((m00 + m01) + m02) + ((m10 + m11) + m12));
        ...
        /// </summary>
        public float Norm1 => (((GlmHalf.Abs(m00) + GlmHalf.Abs(m01)) + GlmHalf.Abs(m02)) + ((GlmHalf.Abs(m10) + GlmHalf.Abs(m11)) + GlmHalf.Abs(m12)));
        ...
        /// </summary>
        public GlmHalf NormMax => GlmHalf.Max(GlmHalf.Max(GlmHalf.Max(GlmHalf.Max(GlmHalf.Max(GlmHalf.Abs(m00), GlmHalf.Abs(m01)), GlmHalf.Abs(m02)), GlmHalf.Abs(m10)), GlmHalf.Abs(m11)), GlmHalf.Abs(m12));

        /// <summary>
        /// Returns the p-norm of this matrix.
        /// </summary>
        public double NormP(double p) => Math.Pow((((Math.Pow((double)GlmHalf.Abs(m00), p) + Math.Pow((double)GlmHalf.Abs(m01), p)) + Math.Pow((double)GlmHalf.Abs(m02), p)) + ((Math.Pow((double)GlmHalf.Abs(m10), p) + Math.Pow((double)GlmHalf.Abs(m11), p)) + Math.Pow((double)GlmHalf.Abs(m12), p))), 1 / p);
        ...
        /// </summary>
        public static hmat2x3 operator+(hmat2x3 lhs, GlmHalf rhs) => new hmat2x3(lhs.m00 + rhs, lhs.m01 + rhs, lhs.m02 + rhs, lhs.m10 + rhs, lhs.m11 + rhs, lhs.m12 + rhs);

        /// <summary>
        /// Executes a component-wise + (add) with a scalar.
        /// </summary>
        public static hmat2x3 operator+(GlmHalf lhs, hmat2x3 rhs) => new hmat2x3(lhs + rhs.m00, lhs + rhs.m01, lhs + rhs.m02, lhs + rhs.m10, lhs + rhs.m11, lhs + rhs.m12);
        ...
        /// </summary>
        public static bmat2x3 operator<(hmat2x3 lhs, GlmHalf rhs) => new bmat2x3(lhs.m00 < rhs, lhs.m01 < rhs, lhs.m02 < rhs, lhs.m10 < rhs, lhs.m11 < rhs, lhs.m12 < rhs);

        /// <summary>
        /// Executes a component-wise lesser-than comparison with a scalar.
        /// </summary>
        public static bmat2x3 operator<(GlmHalf lhs, hmat2x3 rhs) => new bmat2x3(lhs < rhs.m00, lhs < rhs.m01, lhs < rhs.m02, lhs < rhs.m10, lhs < rhs.m11, lhs < rhs.m12);
