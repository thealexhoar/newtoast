...
namespace GlmSharp
{
    ...
    public struct decvec3 : IReadOnlyList<decimal>, IEquatable<decvec3>
    {
        ...
        /// </summary>
        public static explicit operator hvec2(decvec3 v) => new hvec2((GlmHalf)v.x, (GlmHalf)v.y);

        /// <summary>
        /// Explicitly converts this to a hvec3.
        /// </summary>
        public static explicit operator hvec3(decvec3 v) => new hvec3((GlmHalf)v.x, (GlmHalf)v.y, (GlmHalf)v.z);

        /// <summary>
        /// Explicitly converts this to a hvec4. (Higher components are zeroed)
        /// </summary>
        public static explicit operator hvec4(decvec3 v) => new hvec4((GlmHalf)v.x, (GlmHalf)v.y, (GlmHalf)v.z, GlmHalf.Zero);
