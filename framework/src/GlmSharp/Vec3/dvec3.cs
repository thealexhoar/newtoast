...
namespace GlmSharp
{
    ...
    public struct dvec3 : IReadOnlyList<double>, IEquatable<dvec3>
    {
        ...
        /// </summary>
        public static explicit operator hvec2(dvec3 v) => new hvec2((GlmHalf)v.x, (GlmHalf)v.y);

        /// <summary>
        /// Explicitly converts this to a hvec3.
        /// </summary>
        public static explicit operator hvec3(dvec3 v) => new hvec3((GlmHalf)v.x, (GlmHalf)v.y, (GlmHalf)v.z);

        /// <summary>
        /// Explicitly converts this to a hvec4. (Higher components are zeroed)
        /// </summary>
        public static explicit operator hvec4(dvec3 v) => new hvec4((GlmHalf)v.x, (GlmHalf)v.y, (GlmHalf)v.z, GlmHalf.Zero);
