...
namespace GlmSharp
{
    ...
    public struct uvec3 : IReadOnlyList<uint>, IEquatable<uvec3>
    {
        ...
        /// </summary>
        public static implicit operator hvec3(uvec3 v) => new hvec3((GlmHalf)v.x, (GlmHalf)v.y, (GlmHalf)v.z);
        ...
        /// </summary>
        public static explicit operator hvec2(uvec3 v) => new hvec2((GlmHalf)v.x, (GlmHalf)v.y);

        /// <summary>
        /// Explicitly converts this to a hvec4. (Higher components are zeroed)
        /// </summary>
        public static explicit operator hvec4(uvec3 v) => new hvec4((GlmHalf)v.x, (GlmHalf)v.y, (GlmHalf)v.z, GlmHalf.Zero);
