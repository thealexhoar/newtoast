...
namespace GlmSharp
{
    ...
    public struct gmat4<T> : IReadOnlyList<T>, IEquatable<gmat4<T>>
    {
        ...
        /// </summary>
        public static gmat4<T> Zero { get; } = new gmat4<T>(default!, default!, default!, default!, default!, default!, default!, default!, default!, default!, default!, default!, default!, default!, default!, default!);
