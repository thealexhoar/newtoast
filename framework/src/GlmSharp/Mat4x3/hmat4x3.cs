...
namespace GlmSharp
{
    ...
    /// <summary>
    /// A matrix of type GlmHalf with 4 columns and 3 rows.
    /// </summary>
    [Serializable]
    [DataContract(Namespace = "mat")]
    [StructLayout(LayoutKind.Sequential)]
    public struct hmat4x3 : IReadOnlyList<GlmHalf>, IEquatable<hmat4x3>
    {
        ...
        /// </summary>
        public hmat4x3(GlmHalf m00, GlmHalf m01, GlmHalf m02, GlmHalf m10, GlmHalf m11, GlmHalf m12, GlmHalf m20, GlmHalf m21, GlmHalf m22, GlmHalf m30, GlmHalf m31, GlmHalf m32)
        {
            this.m00 = m00;
            this.m01 = m01;
            this.m02 = m02;
        ...
        /// </summary>
        public GlmHalf[,] Values => new[,] { { m00, m01, m02 }, { m10, m11, m12 }, { m20, m21, m22 }, { m30, m31, m32 } };

        /// <summary>
        /// Creates a 1D array with all values (internal order)
        /// </summary>
        public GlmHalf[] Values1D => new[] { m00, m01, m02, m10, m11, m12, m20, m21, m22, m30, m31, m32 };
        ...
        /// </summary>
        public static hmat4x3 Zero { get; } = new hmat4x3(GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero);

        /// <summary>
        /// Predefined all-ones matrix
        /// </summary>
        public static hmat4x3 Ones { get; } = new hmat4x3(GlmHalf.One, GlmHalf.One, GlmHalf.One, GlmHalf.One, GlmHalf.One, GlmHalf.One, GlmHalf.One, GlmHalf.One, GlmHalf.One, GlmHalf.One, GlmHalf.One, GlmHalf.One);

        /// <summary>
        /// Predefined identity matrix
        /// </summary>
        public static hmat4x3 Identity { get; } = new hmat4x3(GlmHalf.One, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.One, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.One, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero);

        /// <summary>
        /// Predefined all-MaxValue matrix
        /// </summary>
        public static hmat4x3 AllMaxValue { get; } = new hmat4x3(GlmHalf.MaxValue, GlmHalf.MaxValue, GlmHalf.MaxValue, GlmHalf.MaxValue, GlmHalf.MaxValue, GlmHalf.MaxValue, GlmHalf.MaxValue, GlmHalf.MaxValue, GlmHalf.MaxValue, GlmHalf.MaxValue, GlmHalf.MaxValue, GlmHalf.MaxValue);

        /// <summary>
        /// Predefined diagonal-MaxValue matrix
        /// </summary>
        public static hmat4x3 DiagonalMaxValue { get; } = new hmat4x3(GlmHalf.MaxValue, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.MaxValue, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.MaxValue, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero);

        /// <summary>
        /// Predefined all-MinValue matrix
        /// </summary>
        public static hmat4x3 AllMinValue { get; } = new hmat4x3(GlmHalf.MinValue, GlmHalf.MinValue, GlmHalf.MinValue, GlmHalf.MinValue, GlmHalf.MinValue, GlmHalf.MinValue, GlmHalf.MinValue, GlmHalf.MinValue, GlmHalf.MinValue, GlmHalf.MinValue, GlmHalf.MinValue, GlmHalf.MinValue);

        /// <summary>
        /// Predefined diagonal-MinValue matrix
        /// </summary>
        public static hmat4x3 DiagonalMinValue { get; } = new hmat4x3(GlmHalf.MinValue, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.MinValue, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.MinValue, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero);

        /// <summary>
        /// Predefined all-Epsilon matrix
        /// </summary>
        public static hmat4x3 AllEpsilon { get; } = new hmat4x3(GlmHalf.Epsilon, GlmHalf.Epsilon, GlmHalf.Epsilon, GlmHalf.Epsilon, GlmHalf.Epsilon, GlmHalf.Epsilon, GlmHalf.Epsilon, GlmHalf.Epsilon, GlmHalf.Epsilon, GlmHalf.Epsilon, GlmHalf.Epsilon, GlmHalf.Epsilon);

        /// <summary>
        /// Predefined diagonal-Epsilon matrix
        /// </summary>
        public static hmat4x3 DiagonalEpsilon { get; } = new hmat4x3(GlmHalf.Epsilon, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Epsilon, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Epsilon, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero);

        /// <summary>
        /// Predefined all-NaN matrix
        /// </summary>
        public static hmat4x3 AllNaN { get; } = new hmat4x3(GlmHalf.NaN, GlmHalf.NaN, GlmHalf.NaN, GlmHalf.NaN, GlmHalf.NaN, GlmHalf.NaN, GlmHalf.NaN, GlmHalf.NaN, GlmHalf.NaN, GlmHalf.NaN, GlmHalf.NaN, GlmHalf.NaN);

        /// <summary>
        /// Predefined diagonal-NaN matrix
        /// </summary>
        public static hmat4x3 DiagonalNaN { get; } = new hmat4x3(GlmHalf.NaN, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.NaN, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.NaN, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero);

        /// <summary>
        /// Predefined all-NegativeInfinity matrix
        /// </summary>
        public static hmat4x3 AllNegativeInfinity { get; } = new hmat4x3(GlmHalf.NegativeInfinity, GlmHalf.NegativeInfinity, GlmHalf.NegativeInfinity, GlmHalf.NegativeInfinity, GlmHalf.NegativeInfinity, GlmHalf.NegativeInfinity, GlmHalf.NegativeInfinity, GlmHalf.NegativeInfinity, GlmHalf.NegativeInfinity, GlmHalf.NegativeInfinity, GlmHalf.NegativeInfinity, GlmHalf.NegativeInfinity);

        /// <summary>
        /// Predefined diagonal-NegativeInfinity matrix
        /// </summary>
        public static hmat4x3 DiagonalNegativeInfinity { get; } = new hmat4x3(GlmHalf.NegativeInfinity, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.NegativeInfinity, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.NegativeInfinity, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero);

        /// <summary>
        /// Predefined all-PositiveInfinity matrix
        /// </summary>
        public static hmat4x3 AllPositiveInfinity { get; } = new hmat4x3(GlmHalf.PositiveInfinity, GlmHalf.PositiveInfinity, GlmHalf.PositiveInfinity, GlmHalf.PositiveInfinity, GlmHalf.PositiveInfinity, GlmHalf.PositiveInfinity, GlmHalf.PositiveInfinity, GlmHalf.PositiveInfinity, GlmHalf.PositiveInfinity, GlmHalf.PositiveInfinity, GlmHalf.PositiveInfinity, GlmHalf.PositiveInfinity);

        /// <summary>
        /// Predefined diagonal-PositiveInfinity matrix
        /// </summary>
        public static hmat4x3 DiagonalPositiveInfinity { get; } = new hmat4x3(GlmHalf.PositiveInfinity, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.PositiveInfinity, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.PositiveInfinity, GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero);
        ...
        /// </summary>
        public GlmHalf MinElement => GlmHalf.Min(GlmHalf.Min(GlmHalf.Min(GlmHalf.Min(GlmHalf.Min(GlmHalf.Min(GlmHalf.Min(GlmHalf.Min(GlmHalf.Min(GlmHalf.Min(GlmHalf.Min(m00, m01), m02), m10), m11), m12), m20), m21), m22), m30), m31), m32);

        /// <summary>
        /// Returns the maximal component of this matrix.
        /// </summary>
        public GlmHalf MaxElement => GlmHalf.Max(GlmHalf.Max(GlmHalf.Max(GlmHalf.Max(GlmHalf.Max(GlmHalf.Max(GlmHalf.Max(GlmHalf.Max(GlmHalf.Max(GlmHalf.Max(GlmHalf.Max(m00, m01), m02), m10), m11), m12), m20), m21), m22), m30), m31), m32);
        ...
        /// </summary>
        public GlmHalf Sum => ((((m00 + m01) + m02) + ((m10 + m11) + m12)) + (((m20 + m21) + m22) + ((m30 + m31) + m32)));
        ...
        /// </summary>
        public float Norm1 => ((((GlmHalf.Abs(m00) + GlmHalf.Abs(m01)) + GlmHalf.Abs(m02)) + ((GlmHalf.Abs(m10) + GlmHalf.Abs(m11)) + GlmHalf.Abs(m12))) + (((GlmHalf.Abs(m20) + GlmHalf.Abs(m21)) + GlmHalf.Abs(m22)) + ((GlmHalf.Abs(m30) + GlmHalf.Abs(m31)) + GlmHalf.Abs(m32))));
        ...
        /// </summary>
        public GlmHalf NormMax => GlmHalf.Max(GlmHalf.Max(GlmHalf.Max(GlmHalf.Max(GlmHalf.Max(GlmHalf.Max(GlmHalf.Max(GlmHalf.Max(GlmHalf.Max(GlmHalf.Max(GlmHalf.Max(GlmHalf.Abs(m00), GlmHalf.Abs(m01)), GlmHalf.Abs(m02)), GlmHalf.Abs(m10)), GlmHalf.Abs(m11)), GlmHalf.Abs(m12)), GlmHalf.Abs(m20)), GlmHalf.Abs(m21)), GlmHalf.Abs(m22)), GlmHalf.Abs(m30)), GlmHalf.Abs(m31)), GlmHalf.Abs(m32));

        /// <summary>
        /// Returns the p-norm of this matrix.
        /// </summary>
        public double NormP(double p) => Math.Pow(((((Math.Pow((double)GlmHalf.Abs(m00), p) + Math.Pow((double)GlmHalf.Abs(m01), p)) + Math.Pow((double)GlmHalf.Abs(m02), p)) + ((Math.Pow((double)GlmHalf.Abs(m10), p) + Math.Pow((double)GlmHalf.Abs(m11), p)) + Math.Pow((double)GlmHalf.Abs(m12), p))) + (((Math.Pow((double)GlmHalf.Abs(m20), p) + Math.Pow((double)GlmHalf.Abs(m21), p)) + Math.Pow((double)GlmHalf.Abs(m22), p)) + ((Math.Pow((double)GlmHalf.Abs(m30), p) + Math.Pow((double)GlmHalf.Abs(m31), p)) + Math.Pow((double)GlmHalf.Abs(m32), p)))), 1 / p);
        ...
        /// </summary>
        public static hmat4x3 operator+(hmat4x3 lhs, GlmHalf rhs) => new hmat4x3(lhs.m00 + rhs, lhs.m01 + rhs, lhs.m02 + rhs, lhs.m10 + rhs, lhs.m11 + rhs, lhs.m12 + rhs, lhs.m20 + rhs, lhs.m21 + rhs, lhs.m22 + rhs, lhs.m30 + rhs, lhs.m31 + rhs, lhs.m32 + rhs);

        /// <summary>
        /// Executes a component-wise + (add) with a scalar.
        /// </summary>
        public static hmat4x3 operator+(GlmHalf lhs, hmat4x3 rhs) => new hmat4x3(lhs + rhs.m00, lhs + rhs.m01, lhs + rhs.m02, lhs + rhs.m10, lhs + rhs.m11, lhs + rhs.m12, lhs + rhs.m20, lhs + rhs.m21, lhs + rhs.m22, lhs + rhs.m30, lhs + rhs.m31, lhs + rhs.m32);
        ...
        /// </summary>
        public static bmat4x3 operator<(hmat4x3 lhs, GlmHalf rhs) => new bmat4x3(lhs.m00 < rhs, lhs.m01 < rhs, lhs.m02 < rhs, lhs.m10 < rhs, lhs.m11 < rhs, lhs.m12 < rhs, lhs.m20 < rhs, lhs.m21 < rhs, lhs.m22 < rhs, lhs.m30 < rhs, lhs.m31 < rhs, lhs.m32 < rhs);

        /// <summary>
        /// Executes a component-wise lesser-than comparison with a scalar.
        /// </summary>
        public static bmat4x3 operator<(GlmHalf lhs, hmat4x3 rhs) => new bmat4x3(lhs < rhs.m00, lhs < rhs.m01, lhs < rhs.m02, lhs < rhs.m10, lhs < rhs.m11, lhs < rhs.m12, lhs < rhs.m20, lhs < rhs.m21, lhs < rhs.m22, lhs < rhs.m30, lhs < rhs.m31, lhs < rhs.m32);
