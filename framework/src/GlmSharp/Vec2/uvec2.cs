...
namespace GlmSharp
{
    ...
    public struct uvec2 : IReadOnlyList<uint>, IEquatable<uvec2>
    {
        ...
        /// </summary>
        public static implicit operator hvec2(uvec2 v) => new hvec2((GlmHalf)v.x, (GlmHalf)v.y);
        ...
        /// </summary>
        public static explicit operator hvec3(uvec2 v) => new hvec3((GlmHalf)v.x, (GlmHalf)v.y, GlmHalf.Zero);

        /// <summary>
        /// Explicitly converts this to a hvec4. (Higher components are zeroed)
        /// </summary>
        public static explicit operator hvec4(uvec2 v) => new hvec4((GlmHalf)v.x, (GlmHalf)v.y, GlmHalf.Zero, GlmHalf.Zero);
