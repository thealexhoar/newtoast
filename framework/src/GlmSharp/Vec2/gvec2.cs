...
namespace GlmSharp
{
    ...
    public struct gvec2<T> : IReadOnlyList<T>, IEquatable<gvec2<T>>
    {
        ...
        /// </summary>
        public static explicit operator gvec3<T>(gvec2<T> v) => new gvec3<T>((T)v.x, (T)v.y, default!);

        /// <summary>
        /// Explicitly converts this to a gvec4. (Higher components are zeroed)
        /// </summary>
        public static explicit operator gvec4<T>(gvec2<T> v) => new gvec4<T>((T)v.x, (T)v.y, default!, default!);
        ...
        /// </summary>
        public static gvec2<T> Zero { get; } = new gvec2<T>(x: default!, y: default!);
