...
namespace GlmSharp
{
    ...
    public struct lvec2 : IReadOnlyList<long>, IEquatable<lvec2>
    {
        ...
        /// </summary>
        public static explicit operator hvec2(lvec2 v) => new hvec2((GlmHalf)v.x, (GlmHalf)v.y);

        /// <summary>
        /// Explicitly converts this to a hvec3. (Higher components are zeroed)
        /// </summary>
        public static explicit operator hvec3(lvec2 v) => new hvec3((GlmHalf)v.x, (GlmHalf)v.y, GlmHalf.Zero);

        /// <summary>
        /// Explicitly converts this to a hvec4. (Higher components are zeroed)
        /// </summary>
        public static explicit operator hvec4(lvec2 v) => new hvec4((GlmHalf)v.x, (GlmHalf)v.y, GlmHalf.Zero, GlmHalf.Zero);
