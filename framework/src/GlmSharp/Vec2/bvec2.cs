...
namespace GlmSharp
{
    ...
    public struct bvec2 : IReadOnlyList<bool>, IEquatable<bvec2>
    {
        ...
        /// </summary>
        public static explicit operator hvec2(bvec2 v) => new hvec2(v.x ? GlmHalf.One : GlmHalf.Zero, v.y ? GlmHalf.One : GlmHalf.Zero);

        /// <summary>
        /// Explicitly converts this to a hvec3. (Higher components are zeroed)
        /// </summary>
        public static explicit operator hvec3(bvec2 v) => new hvec3(v.x ? GlmHalf.One : GlmHalf.Zero, v.y ? GlmHalf.One : GlmHalf.Zero, GlmHalf.Zero);

        /// <summary>
        /// Explicitly converts this to a hvec4. (Higher components are zeroed)
        /// </summary>
        public static explicit operator hvec4(bvec2 v) => new hvec4(v.x ? GlmHalf.One : GlmHalf.Zero, v.y ? GlmHalf.One : GlmHalf.Zero, GlmHalf.Zero, GlmHalf.Zero);
