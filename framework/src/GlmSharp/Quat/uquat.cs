...
namespace GlmSharp
{
    ...
    public struct uquat : IReadOnlyList<uint>, IEquatable<uquat>
    {
        ...
        /// </summary>
        public static implicit operator hquat(uquat v) => new hquat((GlmHalf)v.x, (GlmHalf)v.y, (GlmHalf)v.z, (GlmHalf)v.w);
        ...
        /// </summary>
        public static explicit operator hvec4(uquat v) => new hvec4((GlmHalf)v.x, (GlmHalf)v.y, (GlmHalf)v.z, (GlmHalf)v.w);
