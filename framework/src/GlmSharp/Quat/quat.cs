...
namespace GlmSharp
{
    ...
    public struct quat : IReadOnlyList<float>, IEquatable<quat>
    {
        ...
        /// </summary>
        public static explicit operator hvec4(quat v) => new hvec4((GlmHalf)v.x, (GlmHalf)v.y, (GlmHalf)v.z, (GlmHalf)v.w);

        /// <summary>
        /// Explicitly converts this to a hquat.
        /// </summary>
        public static explicit operator hquat(quat v) => new hquat((GlmHalf)v.x, (GlmHalf)v.y, (GlmHalf)v.z, (GlmHalf)v.w);
