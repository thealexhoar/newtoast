...
namespace GlmSharp
{
    ...
    public struct decquat : IReadOnlyList<decimal>, IEquatable<decquat>
    {
        ...
        /// </summary>
        public static explicit operator hvec4(decquat v) => new hvec4((GlmHalf)v.x, (GlmHalf)v.y, (GlmHalf)v.z, (GlmHalf)v.w);

        /// <summary>
        /// Explicitly converts this to a hquat.
        /// </summary>
        public static explicit operator hquat(decquat v) => new hquat((GlmHalf)v.x, (GlmHalf)v.y, (GlmHalf)v.z, (GlmHalf)v.w);
