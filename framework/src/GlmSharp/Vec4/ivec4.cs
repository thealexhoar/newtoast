...
namespace GlmSharp
{
    ...
    public struct ivec4 : IReadOnlyList<int>, IEquatable<ivec4>
    {
        ...
        /// </summary>
        public static implicit operator hvec4(ivec4 v) => new hvec4((GlmHalf)v.x, (GlmHalf)v.y, (GlmHalf)v.z, (GlmHalf)v.w);
        ...
        /// </summary>
        public static explicit operator hvec2(ivec4 v) => new hvec2((GlmHalf)v.x, (GlmHalf)v.y);

        /// <summary>
        /// Explicitly converts this to a hvec3.
        /// </summary>
        public static explicit operator hvec3(ivec4 v) => new hvec3((GlmHalf)v.x, (GlmHalf)v.y, (GlmHalf)v.z);
