...
namespace GlmSharp
{
    ...
    public struct decvec4 : IReadOnlyList<decimal>, IEquatable<decvec4>
    {
        ...
        /// </summary>
        public static explicit operator hvec2(decvec4 v) => new hvec2((GlmHalf)v.x, (GlmHalf)v.y);

        /// <summary>
        /// Explicitly converts this to a hvec3.
        /// </summary>
        public static explicit operator hvec3(decvec4 v) => new hvec3((GlmHalf)v.x, (GlmHalf)v.y, (GlmHalf)v.z);

        /// <summary>
        /// Explicitly converts this to a hvec4.
        /// </summary>
        public static explicit operator hvec4(decvec4 v) => new hvec4((GlmHalf)v.x, (GlmHalf)v.y, (GlmHalf)v.z, (GlmHalf)v.w);
